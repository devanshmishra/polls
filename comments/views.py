...
class BlogSearchListView():
    ...
    def get_queryset(self):
        ...
        if query:
            ...
            result = result.filter(        reduce(operator.and_,(Q(title__icontains=q) for q in query_list)) |reduce(operator.and_,(Q(content__icontains=q) for q in query_list))
            )
